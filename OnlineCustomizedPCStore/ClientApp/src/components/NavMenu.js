...
export class NavMenu extends Component {
	...
	render() {
		return (
			...
			<div className={this.state.themeMode ? "dark-mode" : "light-mode"}>
							...
							<section className="nav__top">
								<div className="nav__wrapper nav__wrapper--top xs-col-11 xs-mx-auto">
									...
									<ul className="nav__account nav__account--desktop list-unstyled">
										...
										<li className="nav__account--mode" onClick={() => this.ChangeColorMode()} >
											<p className="modeSwitch__label">Light Mode</p>
											<div className="modeSwitch">
												<div className="modeSwitch__wrapper pp_toggle_theme">
													<div className={this.state.themeMode ? "modeSwitch__toggle modeSwitch__toggle--dark-mode" : "modeSwitch__toggle modeSwitch__toggle--light-mode"} />
												</div>
											</div>
										</li>
									</ul>
