...
var Body = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch('api/ComputerComponent/GetUserOptions?UserId=' + UserId)
                                ...
                                data.forEach(function (i) {
                                    _this.state.saveComputerComponent.forEach(function (j) {
                                        if (i.type == j.id) {
                                            j.product = i;
                                            j.status = true;
                                            console.log("lần 1");
                                ...
                                _this.state.saveComputerComponent.forEach(function (j) {
                                    _this.state.computerComponentDatas.forEach(function (k) {
                                        if (j.id == k.id) {
                                            k.status = j.status;
                                        }
                                    });
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fetch('api/ComputerComponent/ListOfComputerComponent')
                                .then(function (response) { return response.json(); })
                                .then(function (data) {
                                _this.setState({
    ...
    Body.prototype.AddUserOption = function () {
        return __awaiter(this, void 0, void 0, function () {
            var saveComputerComponent, ProcessorSku, MainboarSku, RAMSku, HDDSku, SSDSku, VGASku, SourceSku, CaseSku, RadiatorsSku, ScreenSku, KeyboardSku, MouseSku, UserId, message, IsUserChooseOrNot;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        debugger;
                        saveComputerComponent = this.state.saveComputerComponent;
                        ProcessorSku = saveComputerComponent[0].product ? saveComputerComponent[0].product.sku : "0";
                        MainboarSku = saveComputerComponent[1].product ? saveComputerComponent[1].product.sku : "0";
                        RAMSku = saveComputerComponent[2].product ? saveComputerComponent[2].product.sku : "0";
                        HDDSku = saveComputerComponent[3].product ? saveComputerComponent[3].product.sku : "0";
                        SSDSku = saveComputerComponent[4].product ? saveComputerComponent[4].product.sku : "0";
                        VGASku = saveComputerComponent[5].product ? saveComputerComponent[5].product.sku : "0";
                        SourceSku = saveComputerComponent[6].product ? saveComputerComponent[6].product.sku : "0";
                        CaseSku = saveComputerComponent[7].product ? saveComputerComponent[7].product.sku : "0";
                        RadiatorsSku = saveComputerComponent[8].product ? saveComputerComponent[8].product.sku : "0";
                        ScreenSku = saveComputerComponent[9].product ? saveComputerComponent[9].product.sku : "0";
                        KeyboardSku = saveComputerComponent[10].product ? saveComputerComponent[10].product.sku : "0";
                        MouseSku = saveComputerComponent[11].product ? saveComputerComponent[11].product.sku : "0";
                    ...
                    case 1:
                        _a.sent();
                        if (!(IsUserChooseOrNot != 0)) return [3 /*break*/, 4];
                        return [4 /*yield*/, axios_1.default({
                                method: 'put',
                    ...
                    case 3:
                        _a.sent();
                        saveComputerComponent.forEach(function (computerComponent) {
                    ...
                    React.createElement("div", { className: "css-1c5m4ef" },
                        React.createElement("div", { className: "css-l6dpr4" }, this.state.computerComponentDatas.map(function (computer, key) {
                            return (React.createElement(computerComponent_1.default, { key: key, item: computer, handleChangeStatus: _this.handleChangeStatus(computer), computerComponentDetailData: _this.state.computerComponentDetailData, ComputerComponent: _this.state.ComputerComponent, TotalPrice: function (item) {
                                ...
                                }, AddUserOption: function () { return _this.AddUserOption(); } }));
                        })),
